...
class Spellchecker : public Nan::ObjectWrap {
  ...
  static NAN_METHOD(CheckSpelling) {
    ...
    string->Write(Isolate::GetCurrent(), reinterpret_cast<uint16_t *>(text.data()));
  ...
  static NAN_METHOD(CheckSpellingAsync) {
    ...
    string->Write(Isolate::GetCurrent(), reinterpret_cast<uint16_t *>(corpus.data()));
 ...
 public:
  static void Init(Local<Object> exports) {
    ...
    exports->Set(Nan::New("Spellchecker").ToLocalChecked(), Nan::GetFunction(tpl).ToLocalChecked());
  }
};
